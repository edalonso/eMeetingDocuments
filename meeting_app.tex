...
descarga de un \textit{plugin}, y 4 servidores que se detallan
a continuación\@.
...
al descargar al servidor Directorio + de las consultas que se realicen sobre
...
aunque podría asociarse a la tabla meeting ya que cada las reuniomes se realizan en una sala,
...
funciones que se describirán en el interfaz de usuario\@. Las variables
...
de la reunión y agiliza la toma decisiones a la hora de eliminar
