...
\vspace{1 cm}
\subsection*{\centering{Diseño, desarrollo y puesta en servicio de una aplicación web para la gestión de salas virtuales de videoconferencia \textit{Adobe Connect}}}
...
una herramienta esencial para el correcto desarrollo empresarial,
...
para ampliar sus grupos de investigación como para poder conpartir
...
que simplificará nuestro trabajo a la hora de diseñar la aplicación.
...
a una rápida resolución de errores. Hemos elegido PHP 5 porque
...
y controlarlas desde nuestra aplicación\@. La experiencia nos hace
saber que el uso de Adobe Connect Profesional\textsuperscript{®}
es complejo para cualquier usuario que no posea un perfil tÃ©cnico
...
Para almacenar toda la información de nuestra aplicación, tanto de
...
acotarÃ¡ enormemente el tiempo de búsqueda de soluciones ante errores
...
tÃ©cnicos o lecturas extensas. Para ello usaremos la biblioteca
de Javascript jQuery. Su gran capacidad para personalizar el diseño
de nuestra pÃ¡gina y la facilidad para crear funcionalidades y animaciones
avanzadas nos proporcionará unos magníficos resultados. Las interacciones
AJAX son otro punto a tener en cuenta a la hora de utilizar jQuery
ya que simplifica enormemente su utilización y nos da la capacidad
...
relevante. Un ejemplo sencillo sería comunicar una agenda con nuestra
aplicación, de este modo si se agenda una reunión de videoconferencia
nuestra aplicación reservará una sala que se encontrará disponible
en nuestro perfil. Para ello debemos dotar a la aplicación de las
...
\begin{figure}
\hspace{4cm}\includegraphics[scale=0.6]{Diseno/comunciacion_modif}
...
\begin{figure}
\hspace{5cm}\includegraphics[scale=0.6]{Diseno/PHP_arq}
...
\hspace{1.3cm}\includegraphics[scale=0.5]{Diseno/apache_estruc}
...
\end{enumerate}
\begin{figure}
\hspace{3.4cm}\includegraphics[scale=0.3]{Diseno/RelacionUsuarioAdobeFlashPlayer}
...
\begin{figure}
\hspace{1.8cm}\includegraphics[scale=0.5]{Diseno/Esquema_aplicacion}
...
\begin{figure}[h]
\hspace{2.5cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Meeting\string".png}
...
\end{itemize}
\begin{figure}[h]
\hspace{2.5cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/User\string".png}
...
\end{itemize}
\begin{figure}[h]
\hspace{2.5cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Recording\string".png}
...
\end{itemize}
\begin{figure}[h]
\hspace{3cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Log\string".png}
...
\begin{figure}[h]
\hspace{3cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Log_Total\string".png}
...
\begin{figure}[h]
\hspace{3.5cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Meeting_user\string".png}
...
\begin{figure}[h]
\hspace{2.5cm}\includegraphics[scale=0.5]{\string"Diseno/Imagenes base de datos/Staff\string".png}
...
\begin{figure}[H]
\hspace{3cm}\includegraphics[scale=0.4]{Diseno/boceto}
...
\begin{figure}[H]
\hspace{3cm}\includegraphics[scale=0.3]{Diseno/version_1}
...
\begin{figure}[H]
\hspace{4cm}\includegraphics[scale=0.35]{Diseno/achievement_files}
...
\begin{figure}[H]
\hspace{3.5cm}\includegraphics[scale=0.4]{Diseno/InviteDigiMarPartners}
...
\begin{table}[H]
\hspace{2cm}\includegraphics[width=12cm,height=7cm]{Diseno/CAS}
...
\hspace{5cm}\subfloat[Formulario de acceso con diseño ``Campus do Mar'']{\includegraphics[scale=0.35]{Diseno/login}\hspace{0.8cm}
