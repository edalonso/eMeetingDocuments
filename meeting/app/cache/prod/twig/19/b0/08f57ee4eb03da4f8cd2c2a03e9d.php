  ...
  ";
    ...
    ";
            ...
            if (($this->getAttribute($this->getContext($context, "recording"), "state") == 0)) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_public_recording", array("id" => $this->getAttribute($this->getContext($context, "recording"), "id"))), "html", null, true);
    ...
    ";
                ...
                echo "     <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_public_recording", array("id" => $this->getAttribute($this->getContext($context, "recording"), "id"))), "html", null, true);
                echo "\" style=\"color: grey; text-shadow: none; text-decoration:none\"> ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "recording"), "title"), "html", null, true);
                echo "</a>
    ";
            }
            // line 19
            echo "      <span style=\"font-size: 12px; font-style: italic; margin: 5px; padding-bottom: 5px; margin-left: 10px;text-shadow: none;\"> at ";
