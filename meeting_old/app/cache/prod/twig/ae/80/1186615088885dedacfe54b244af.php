...
class __TwigTemplate_ae801186615088885dedacfe54b244af extends Twig_Template
{
  ...
  <div class=\"info\" style=\"float:right; width:200px; padding: 10px 20px; margin:10px 0px; border-left:1px solid\">
    <button id=\"opener-delete-";
        ...
        if (($this->getAttribute($_meeting_, "owner") != $_user_)) {
            echo " disabled=\"true\" ";
        }
    ...
    <div style=\"float: left;\" class=\"locked\">
      ";
        // line 5
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        if ($this->getAttribute($_meeting_, "isLocked")) {
            // line 6
      ...
      <a  ";
            ...
            if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            if (($this->getAttribute($_user_, "id") != $this->getAttribute($this->getAttribute($_meeting_, "owner"), "id"))) {
                echo " href=\"javascript:plegardesplegar ('capasuperior');\" ";
            } else {
                echo " href=\"";
                if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("locked_meeting", array("id" => $this->getAttribute($_meeting_, "id"), "locked" => 0)), "html", null, true);
                echo "\" ";
            }
            echo "><button ";
            if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
      ...
      ";
            ...
            if (($this->getAttribute($_user_, "id") != $this->getAttribute($this->getAttribute($_meeting_, "owner"), "id"))) {
                ...
                echo " href=\"";
                if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("locked_meeting", array("id" => $this->getAttribute($_meeting_, "id"), "locked" => 1)), "html", null, true);
                echo "\" ";
            }
            echo "><button ";
            if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
    ...
    <div style=\"padding-top: 10px\">
      ...
      <span style=\"font-size: 14px; font-style: italic\">";
        // line 16
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($_meeting_, "date"), "Y-m-d H:i"), "html", null, true);
        echo "</span>
    </div>
    <div>
      ...
      <span style=\"font-size: 14px; font-style: italic\">";
        // line 20
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        if (($this->getAttribute($_meeting_, "public") == 1)) {
    ...
    <div>
      ...
      <span style=\"font-size: 14px; font-style: italic\"> ";
        // line 24
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, (twig_length_filter($this->env, $this->getAttribute($_meeting_, "users")) + 1), "html", null, true);
        echo " </span>
...
\t});
  ...
  <div class=\"body\" style=\"padding-right: 210px;\">
    <div style=\"float: right; margin-right: 15px\">
      ";
        // line 102
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        if ($this->getAttribute($_meeting_, "public")) {
            // line 103
            echo "        <a class=\"go\" target=\"_blank\" href=\"";
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_room", array("salt" => $this->getAttribute($_meeting_, "salt"))), "html", null, true);
      ...
      ";
            ...
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_secretroom", array("salt" => $this->getAttribute($_meeting_, "secretsalt"))), "html", null, true);
            echo "\" style=\"text-decoration:none\"><button style=\"padding: 20px 8px;\" class=\"button green\"><i class=\"icon-upload icon-white\"></i> Join</button></a>
      ";
        }
        // line 107
        echo "    </div>
    <p style=\"font-size:45px; text-align: left;\">";
        // line 108
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_meeting_, "title"), "html", null, true);
        echo "</p>
    <div style=\"float: rigth; margin-top: 20px; padding: 10px;\">
      ";
        // line 110
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        if (($this->getAttribute($_meeting_, "description") != null)) {
            // line 111
            echo "        <div>
  \t  <b>Description</b>
  \t  <p style=\"margin: 15px; margin-top: 5px\">";
            // line 113
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($_meeting_, "description"), "html", null, true);
            echo "</p>
        </div>
      ";
        }
...
\t<p style=\"margin-bottom: 5px\">Invite External Partners (Presenter Access): <i id=\"opener-invite-";
  ...
  \t  <input type=\"text\" readonly=\"readonly\" style=\"border: 1px solid #ccc; width: 52%; margin: 0px 0px 10px 10px;\" onclick=\"this.select()\" value=\"";
            // line 121
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("index_room", array("salt" => $this->getAttribute($_meeting_, "salt"))), "html", null, true);
            echo "\" />
\t</li>
      </ul>
      ";
...
\t<p style=\"margin-bottom: 5px\">Invite External Partners (Presenter Access): <i id=\"opener-invite1-";
  ...
  \t  <input type=\"text\" readonly=\"readonly\" style=\"border: 1px solid #ccc; width: 52%; margin: 0px 0px 10px 10px;\" onclick=\"this.select()\" value=\"";
            // line 128
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("index_secretroom", array("salt" => $this->getAttribute($_meeting_, "secretsalt"))), "html", null, true);
            echo "\" />
\t  ";
            // line 129
            if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
...
\t  ";
  ...
  \t  <input type=\"text\" readonly=\"readonly\" style=\"border: 1px solid #ccc; width: 52%; margin: 0px 0px 10px 10px;\" onclick=\"this.select()\" value=\"";
            // line 135
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("index_secretroom", array("salt" => $this->getAttribute($_meeting_, "viewsalt"))), "html", null, true);
            echo "?guest=true\" />
\t  ";
            // line 136
            if (isset($context["user"])) { $_user_ = $context["user"]; } else { $_user_ = null; }
...
\t  ";
  ...
  <div id=\"dialog-modal-users-";
        ...
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_form", array("id" => $this->getAttribute($_meeting_, "id"))), "html", null, true);
...
\t<font size=\"4\">Are you sure?</font>
      ...
      <a href=\"";
        // line 155
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("index_cancel", array("id" => $this->getAttribute($_meeting_, "id"))), "html", null, true);
...
\t<font size=\"4\">Are you sure?</font>
      ...
      <a href=\"";
        // line 166
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("updatesecretsalt_meeting", array("id" => $this->getAttribute($_meeting_, "id"))), "html", null, true);
        echo "\" style=\"text-decoration:none\"><button class=\"button red\"><i class=\"icon-trash icon-white\"></i>Yes, I'm sure</button></a>
    </div>
  </div>
...
\t<font size=\"4\">Are you sure?</font>
      ...
      <a href=\"";
        // line 177
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("updateviewsalt_meeting", array("id" => $this->getAttribute($_meeting_, "id"))), "html", null, true);
        echo "\" style=\"text-decoration:none\"><button class=\"button red\"><i class=\"icon-trash icon-white\"></i>Yes, I'm sure</button></a>
    </div>
  </div>
...
";
        // line 198
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("index_room", array("salt" => $this->getAttribute($_meeting_, "secretsalt"))), "html", null, true);
        echo "
...
";
        // line 209
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("index_room", array("salt" => $this->getAttribute($_meeting_, "viewsalt"))), "html", null, true);
        echo "
...
<div id=\"dialog-modal-nickname-";
  ...
  <div class=\"np\" style=\"padding: 50px 30px 15px;\">
    <form action=\"";
      ...
      ";
        // line 220
        if (isset($context["nicknames"])) { $_nicknames_ = $context["nicknames"]; } else { $_nicknames_ = null; }
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        if (($this->getAttribute($_nicknames_, $this->getAttribute($_meeting_, "id"), array(), "array") != null)) {
            // line 221
            echo "      <input type=\"hidden\" name=\"id_nickname\" value=\"";
            if (isset($context["nicknames"])) { $_nicknames_ = $context["nicknames"]; } else { $_nicknames_ = null; }
            if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_nicknames_, $this->getAttribute($_meeting_, "id"), array(), "array"), "id"), "html", null, true);
            echo "\" />
      ";
        }
        // line 223
...
\t<li style=\"list-style-type: none;\"><label for=\"form_NickName\" class=\"required\" style=\"margin: 10px;\">Nick Name: </label><input id=\"NickName\" name=\"Nick_name\" type=\"text;\" value=\"";
        ...
        if (isset($context["nicknames"])) { $_nicknames_ = $context["nicknames"]; } else { $_nicknames_ = null; }
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_nicknames_, $this->getAttribute($_meeting_, "id"), array(), "array"), "html", null, true);
        echo "\"></input></li>
...
<div id=\"dialog-modal-recordings-";
        ...
        echo "\" class=\"dialog-modal\" data-ajax=\"true\" data-url=\"";
        if (isset($context["meeting"])) { $_meeting_ = $context["meeting"]; } else { $_meeting_ = null; }
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("recording_list", array("id" => $this->getAttribute($_meeting_, "id"))), "html", null, true);
