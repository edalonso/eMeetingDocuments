...
\t<li style=\"list-style-type: none; overflow: hidden; font-size: 18px; margin-bottom: 5px;\">
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($_user_, "login"), "html", null, true);
...
";
        // line 78
        if (isset($context["meetings_now"])) { $_meetings_now_ = $context["meetings_now"]; } else { $_meetings_now_ = null; }
        if ((!twig_test_empty($_meetings_now_))) {
            // line 79
            echo "
";
            // line 81
  ...
  ";
            ...
            $context['_seq'] = twig_ensure_traversable($_meetings_now_);
            $context['loop'] = array(
