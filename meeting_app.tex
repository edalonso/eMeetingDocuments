...
de nuestra página y la facilidad para crear funcionalidades y animaciones
...
\begin{figure}
\centerline{\includegraphics[scale=0.6]{Diseno/comunciacion_modif}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.5]{EstructuraDirectoriosSymfony}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.5]{ExplicacionEstructuraDirectoriosSymfony}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.6]{Diseno/PHP_arq}}
...
\centerline{\includegraphics[scale=0.5]{Diseno/apache_estruc}}
...
caso de eMeeting será \textit{emeeting.campusdomar.es, emeetings.campusdomar.es, meeting.campusdomar.es, meetings.cam\-pusdomar.es}, a la carpeta \textit{web} de Symfony donde se
...
\end{enumerate}
\begin{figure}
\centerline{\includegraphics[scale=0.3]{Diseno/RelacionUsuarioAdobeFlashPlayer}}
...
este echo facilita la integración de módulos concretos de Symfony en diferentes aplicaciones
...
\begin{figure}
\centerline{\includegraphics[scale=0.5]{Diseno/Esquema_aplicacion}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.4]{\string"Fotos de eMeeting/HelpMeeting\string".png}}
...
\begin{figure}
\centerline{\includegraphics[scale=0.4]{\string"Fotos de eMeeting/Fotos antiguas/inciosineMeetings\string".png}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.4]{Diseno/boceto}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.3]{Diseno/version_1}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.35]{Diseno/achievement_files}}
...
funcionalidades proporcionadas por eMeeting y explica cómo
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.4]{Diseno/InviteDigiMarPartners}}
...
\begin{table}[H]
\centerline{\includegraphics[width=12cm,height=7cm]{Diseno/CAS}}
...
\end{itemize}
\begin{figure}[H]
\centerline{\includegraphics[scale=0.25]{\string"Fotos de eMeeting/editForm\string".png}}
...
\end{itemize}
\begin{figure}[H]
\centerline{\includegraphics[scale=0.25]{\string"Fotos de eMeeting/MeetingAdminForm\string".png}}
...
\end{itemize}
\begin{figure}[H]
\centerline{\includegraphics[scale=0.3]{\string"Fotos de eMeeting/Fotos antiguas/eMeeting Final Help/InvitePartners\string".png}}
...
\begin{figure}[H]
\centerline{\includegraphics[scale=0.45]{R/participantes}}
