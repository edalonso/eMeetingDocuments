 ...
 */
class CmarMeetingBundleEntityGroupProxy extends \Cmar\MeetingBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'key', 'name', 'description', 'type', 'users');
    }
